...
public class TokenExchangeIT {
	...
	public void testTokenExchange() throws GeneralSecurityException, IOException, InterruptedException {
		...
		Assertions.assertEquals("alice", jwt.getClaim("preferred_username").asString());
		MatcherAssert.assertThat(jwt.getClaim("scope").asString(), Matchers.containsStringIgnoringCase("email"));
	}
